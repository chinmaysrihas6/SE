...
<body style="height: 1100px;">
    <div class="mainbody">
        ...
        <div class="img"
            style="background-image: url(company.jpg); display: flex; justify-content: center; align-items: center;">
            <div class="search">
                <form class="form-inline" action="/action_page.php">
                    <input class="form-control form-control-lg mr-sm-3" type="text" placeholder="Search">
